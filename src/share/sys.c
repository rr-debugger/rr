...
void sys_ptrace_setup(pid_t pid)
{
	sys_ptrace(PTRACE_SETOPTIONS, pid, 0,
			(void*) (PTRACE_O_TRACESECCOMP | PTRACE_O_TRACESYSGOOD | PTRACE_O_TRACEFORK | PTRACE_O_TRACEVFORK | PTRACE_O_TRACECLONE | PTRACE_O_TRACEEXEC | PTRACE_O_TRACEVFORKDONE | PTRACE_O_TRACEEXIT));
}
