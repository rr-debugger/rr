...
#define RR_PAGE_INFINITE_LOOP_ADDR (RR_PAGE_ADDR)
#define RR_PAGE_IN_TRACED_SYSCALL_ADDR (RR_PAGE_ADDR + 16 + 2)
#define RR_PAGE_IN_PRIVILEGED_TRACED_SYSCALL_ADDR (RR_PAGE_ADDR + 32 + 2)
#define RR_PAGE_IN_UNTRACED_REPLAYED_SYSCALL_ADDR (RR_PAGE_ADDR + 48 + 2)
#define RR_PAGE_IN_UNTRACED_SYSCALL_ADDR (RR_PAGE_ADDR + 64 + 2)
#define RR_PAGE_IN_PRIVILEGED_UNTRACED_SYSCALL_ADDR (RR_PAGE_ADDR + 80 + 2)
