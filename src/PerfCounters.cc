...
static const PmuConfig pmu_configs[] = {
  { IntelKabylake, "Intel Kabylake", 0x5101c4, 0x5100c0, 0x5301cb, 500, true,
    false },
  { IntelSilvermont, "Intel Silvermont", 0x517ec4, 0x5100c0, 0x5301cb, 500,
    true, true },
  { IntelSkylake, "Intel Skylake", 0x5101c4, 0x5100c0, 0x5301cb, 500, true,
    false },
  { IntelBroadwell, "Intel Broadwell", 0x5101c4, 0x5100c0, 0x5301cb, 500, true,
    false },
  { IntelHaswell, "Intel Haswell", 0x5101c4, 0x5100c0, 0x5301cb, 500, true,
    false },
  { IntelIvyBridge, "Intel Ivy Bridge", 0x5101c4, 0x5100c0, 0x5301cb, 500, true,
    false },
  { IntelSandyBridge, "Intel Sandy Bridge", 0x5101c4, 0x5100c0, 0x5301cb, 500,
    true, false },
  { IntelNehalem, "Intel Nehalem", 0x5101c4, 0x5100c0, 0x50011d, 500, true,
    false },
  { IntelWestmere, "Intel Westmere", 0x5101c4, 0x5100c0, 0x50011d, 500, true,
    false },
  { IntelPenryn, "Intel Penryn", 0, 0, 0, 500, false, false },
  { IntelMerom, "Intel Merom", 0, 0, 0, 500, false, false },
