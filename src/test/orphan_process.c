...
int main(int argc, char *argv[]) {
	/* Descendant process will write one byte to the pipe to signal that it's complete */
	int pipe_fds[2];
	...
	/* Now the rr supervisor process is no longer our ancestor in the process tree.
           Try forking again. */
